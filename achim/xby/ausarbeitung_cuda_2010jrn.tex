...
\begin{tabular}[ht]{|l|c|l|}
  ...
  \hline
  matrixmul & $   \vec{\bf{c}}= \bf{A}_{full} \cdot \vec{b} $ & $\bf{A_{full}}$ dünnbesetzt\\
  \hline
...
\input{.//xby//Implementierung_dotmul}
\input{.//xby//Implementierung_vollmatrize}
\input{.//xby//Implementierung_sparematrize}
...
\input{.//xby//dreieck_massig}
\input{.//xby//minimierung_leerthreads}
\input{.//xby//share_memory}
\input{.//xby//block_uebergreiffen}

\section{Testergebnisse}

\subsection{Sparse Matrixvektormultiplikation}

\input{.//xby//sparsemul_result}
