...
\lable{fig:Vektor Multiplikation}
\end{figure}
...
\begin{firuge}[htbp]
\centering
\includegraphics[height=3cm,width=3cm]{.//pic//MatrixVektor}
\caption{Matriz mal Vektor. A:Matrize; b: Vektor; c: produkt Vektor}
\lable{fig:MatrixVektor-Multiplikation}
\end{figure}
...
\begin{minipage}[t]{0.3\textwidth}
	\centering
	\includegraphics[height=3cm,width=3cm]{.//pic//orignal_sparse}
	\caption{Originale-Matrize}
\end{minipage}
\begin{minipage}[t]{0.3\textwidth}
	\centering
	\includegraphics[height=3cm,width=3cm]{.//pic//numerische_sparse1}
	\caption{Sparsame Struktur}
\end{minipage}
\begin{minipage}[t]{0.3\textwidth}
	\centering
	\includegraphics[height=3cm,width=3cm]{.//pic//numerische_sparse2}
...
\begin{firuge}[htbp]
\centering
\includegraphics[height=3cm,width=3cm]{.//pic//sparseMul}
...
\lable{fig:Sparsematriz-Multiplikation}
\end{figure}
...
\begin{firuge}[htbp]
\centering
\includegraphics[height=3cm,width=3cm]{.//pic//dreieck}
...
\begin{minipage}[t]{0.3\textwidth}
	\centering
	\includegraphics[height=3cm,width=3cm]{.//pic//einDiagonal}
...
\begin{minipage}[t]{0.3\textwidth}
	\centering
	\includegraphics[height=3cm,width=3cm]{.//pic//moreDiagonal}
...
\begin{firuge}[htbp]
\centering
\includegraphics[height=3cm,width=3cm]{.//pic//compareSparse}
...
\begin{firuge}[htbp]
\centering
\includegraphics[height=3cm,width=3cm]{.//pic//sharememory}
