...
CUDA \cite{cudapg} ist ein API um Software für die Ausführung auf GPUs des Herstellers nvidia entwickeln zu können.
...
Testproblem für das Messen ist das LGS für die Kondensatorkante:
$() = ()$
Pro Iterationsschritt $i$ wird das Residuum $r_i = | \bf{A} \cdot \vec{\bf{x_i}} - \vec{b} |$ aufgezeichnet und dann
im Diagramm gegen $i$ aufgetragen.
