...
set PATH=%VCINSTALLDIR%\BIN\;%VCINSTALLDIR%\masm32\bin;%VSINSTALLDIR%\Common7\IDE;%VSINSTALLDIR%\SDK\v2.0\bin;%VSINSTALLDIR%\Common7\Tools;%VSINSTALLDIR%\Common7\Tools\bin;%VCINSTALLDIR%\VCPackages;f:\masm32\bin;%MATLAB_BIN%;%PATH%
...
set LIB=%VCINSTALLDIR%\ATLMFC\LIB;%VCINSTALLDIR%\LIB;%VCINSTALLDIR%\PlatformSDK\lib;%VSINSTALLDIR%\SDK\v2.0\lib;%MATLAB%\extern\lib\win32;C:\Programme\Microsoft SDKs\Windows\v6.0A\Lib;%LIB%
