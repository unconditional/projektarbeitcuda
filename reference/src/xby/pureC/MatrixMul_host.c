...
void randomInit(float*, int, bool);
...
runTest(int argc, char** argv)
{
    ...
    randomInit(h_A, size_A, false);
    randomInit(h_B, size_B, false);
	...
	/*
    // compute reference solution in CPU
...
void randomInit(float* data, int size,bool randVal)
{
